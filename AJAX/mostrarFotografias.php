...
if ($rowcount==0) {
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		echo '<td><img src="data:image/jpg;base64,'.base64_encode( $row['imagen'] ).'" width=200 height =200/></td>';
		echo '<td><a onClick="eliminarFotografiaAJAX()"><img id="'.$row["codfoto"].'" class="imgcheck2" src="../images/Red_check.png"/></a></td></tr>';
	}
	echo '</table>';
}
