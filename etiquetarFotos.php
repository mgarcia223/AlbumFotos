	...
	<div>
		...
		<div id="boton" style="visibility: hidden;">
			<form id="etiqueta" method="POST">
				Etiqueta: <input type='text' id="etiq" name="etiq">
			</form>
			<input name="etiquetar" type="button" value="Etiquetar fotografia" onClick="etiquetarFotografiaAJAX()">
		</div>	
		<div id="mensaje"></div>
	</div>
    </section>
...
<script>
	...
	function etiquetarFotografiaAJAX() {
	...
	if (etiq!="") {
		$("#mensaje").css("visibility", "visible");
			$.ajax({
				url: 'AJAX/insertarEtiqueta.php',
				type: "POST",
				data: "cod="+cod2+"&etiq="+etiq,
